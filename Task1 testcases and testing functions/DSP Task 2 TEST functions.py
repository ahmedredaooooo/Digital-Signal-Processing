...
x, y = ReadSignalFile('output/add.txt')
AddSignalSamplesAreEqual("Signal1.txt", "Signal2.txt", x, y) # call this function with your computed indicies and samples
...
x, y = ReadSignalFile('output/subtract.txt')
SubSignalSamplesAreEqual("Signal1.txt", "Signal2.txt",x,y)  # call this function with your computed indicies and samples
...
x, y = ReadSignalFile('output/mul.txt')
MultiplySignalByConst(5,x, y)# call this function with your computed indicies and samples
...
x, y = ReadSignalFile('output/advance.txt')
ShiftSignalByConst(3,x,y)  # call this function with your computed indicies and samples

x, y = ReadSignalFile('output/delay.txt')
ShiftSignalByConst(-3,x,y)  # call this function with your computed indicies and samples
...
x, y = ReadSignalFile('output/folding.txt')
Folding(x,y)  # call this function with your computed indicies and samples
